...
| `-v, --viewer-ids <ids>` | 观众 ID，多个用逗号分隔 |
...
```bash
# 频道级别踢人
npx polyv-live-cli@latest chat kick -c 3151318 -v viewer1,viewer2 -n Nick1,Nick2

# 全局踢人
npx polyv-live-cli@latest chat kick -v viewer1 --global

# JSON 格式输出
npx polyv-live-cli@latest chat kick -c 3151318 -v viewer1 -o json
```
...
```bash
# 频道级别解踢
npx polyv-live-cli@latest chat unkick -c 3151318 -v viewer1 -n Nick1

# 全局解踢
npx polyv-live-cli@latest chat unkick -v viewer1 --global
```
