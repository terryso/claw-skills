...
Usage:
    python fetch_transcript.py <url_or_video_id> [--language en,zh] [--timestamps] [--text-only]
...
Output (plain text, with --text-only):
    Timestamped text (if --timestamps) or raw text only.

Install dependency:  pip3 install youtube-transcript-api
"""
